...
public class DevInitData {
    ...
    CommandLineRunner initData(
        ...
        return args -> {
            ...
            Product product1 = productService.create(member1, "상품명1 상품명1 상품명1 상품명1 상품명1 상품명1", 30_000, "자바", "#IT #카프카");
