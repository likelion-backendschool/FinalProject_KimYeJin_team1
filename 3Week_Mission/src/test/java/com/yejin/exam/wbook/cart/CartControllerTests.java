package com.yejin.exam.wbook.cart;

import com.yejin.exam.wbook.domain.cart.controller.CartController;
...
public class CartControllerTests {
    ...
    void t2() throws Exception {
        ...
        System.out.println("[cart] cartService.getItemsByBuyer(new Member(1)) : " + cartService.getItemsByBuyer(new Member(1)));
